...
public class AgencyInfoService {
    ...
    public String save(AgencyInfoDto dto) {
        AgencyInformation entity = AgencyInfoDto.toEntity(dto);
        repository.save(entity);

        return entity.getAgencyCd();
    }

    public AgencyInformation get(String agyCd) {
    ...
    public void encryptSaving(int id, AgencyDto agencyDto) throws Exception {
        ...
        AgencyInformation entity = AgencyInformation.builder()
    ...
    public void reEncryptSaving() throws Exception {
        ...
        List<AgencyInformation> all = repository.findByCreatedDateGreaterThanAndModifiedDateLessThan(created, modified);

        for (AgencyInformation entity : all) {
